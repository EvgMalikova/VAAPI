...
{
public:
    void SetHeteroObjType(int type);
    ...
    void SetBoundingBox(optix::float3 bmin, optix::float3 bmax)
    {
   ...
   */
    ...
    */
    ...
    void SetPostProcessMaterial(optix::Program sdfProg, optix::Program colProg);
private:
    int m_primType;
    bool m_AudioWidget;
    RenderModes m_mode;
