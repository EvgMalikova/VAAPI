Example of custom optical material creation on base of Emission-\/absorption Volume.\doxysection{C++ files}\label{md_doc_materialtutorial_autotoc_md6}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\doxysection{Cuda files}\label{md_doc_materialtutorial_autotoc_md7}
